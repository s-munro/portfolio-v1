...
const Ome = (props) => {
  ...
  return (
    <div className="container main-body d-flex justify-content-center">
      <div className="row w-100 d-flex justify-content-center align-items-center pt-5 home-mobile-padding-top">
        <div className="col-xl-6 col-lg-7 col-md-12 home-mobile-padding-top">
          <AnimatedHeader />
          <div
            data-aos="fade-up"
            data-aos-delay="400"
        ...
        <div className="col-xl-6 col-lg-5 col-md-12 d-flex flex-column justify-content-center align-items-center">
          <div
            data-aos="fade-up"
            data-aos-delay="1300"
